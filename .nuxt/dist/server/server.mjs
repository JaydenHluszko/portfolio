import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, provide, h, ref, Suspense, Fragment, resolveComponent, computed, unref, mergeProps, useSSRContext, withCtx, createTextVNode, createVNode, defineAsyncComponent, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
import { $fetch } from "D:/Documents/Jayden/Jayden-Portfolio/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "D:/Documents/Jayden/Jayden-Portfolio/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "D:/Documents/Jayden/Jayden-Portfolio/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "D:/Documents/Jayden/Jayden-Portfolio/node_modules/h3/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, RouterView } from "vue-router";
import { defu } from "D:/Documents/Jayden/Jayden-Portfolio/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, parseURL, encodePath, decodePath, withQuery, isScriptProtocol, parseQuery, withTrailingSlash, withoutTrailingSlash } from "D:/Documents/Jayden/Jayden-Portfolio/node_modules/ufo/dist/index.mjs";
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-D84MpgWb.js")
  },
  {
    name: "resume",
    path: "/resume",
    component: () => import("./_nuxt/resume-g5gZarYg.js")
  },
  {
    name: "case-studies-ai-claim-builder",
    path: "/case-studies/ai-claim-builder",
    component: () => import("./_nuxt/ai-claim-builder-BfbuR936.js")
  },
  {
    name: "case-studies-growth-driven-redesign",
    path: "/case-studies/growth-driven-redesign",
    component: () => import("./_nuxt/growth-driven-redesign-DZggLCXW.js")
  },
  {
    name: "case-studies-multi-tenant-design-system",
    path: "/case-studies/multi-tenant-design-system",
    component: () => import("./_nuxt/multi-tenant-design-system-BAtOupit.js")
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-C3Z18h4B.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-BwAt3OrF.js"));
